...
const webAnalyticsTwo = ( props ) => {
	const { menuState } = useContext(vuroxContext)
	
	const [doubleBarChartData, setDoubleBarChartData ] = useState([])	

	const visitors = props.company.visitors[0].dailyStats
	const profit = props.company.profit
	const barChartData = processDualChartsData( visitors, profit, 'date', 'visitors', 'profit', 20 )
								...
								<Row>
									<Col md={8} xs={24}>
										...
										<ResponsiveContainer className="d-inline-block" width='30%' height={60}>
											<BarChart data={props.company.visitors[0].dailyStats}  margin={{ top: 20, right: 5, left: 0, bottom: 12 }}>
										...
										<h4 className="vurox-fw-300 d-inline-block align-bottom mb-1">
											{props.company.visitors[0].dailyTotal } 
									...
									<Col md={8} xs={24}>
										<ResponsiveContainer className="d-inline-block" width='30%' height={60}>
											<BarChart data={props.company.orders[0].dailyStats}  margin={{ top: 20, right: 5, left: 0, bottom: 12 }}>
												<Tooltip contentStyle={vuroxDarkToolTipStyles} cursor={false} />
												<Bar dataKey="value" fill="#50bc5e" barSize={2} barGap ={2} />
											</BarChart>
										</ResponsiveContainer>
										<h4 className="vurox-fw-300 d-inline-block align-bottom mb-1">{props.company.orders[0].dailyTotal} <small className="vurox-text-sizes"> New Users</small></h4>
										
									</Col>
									<Col md={8} xs={24}>
										<ResponsiveContainer className="d-inline-block" width='30%' height={60}>
											<BarChart data={props.company.bounce[0].dailyStats}  margin={{ top: 20, right: 5, left: 0, bottom: 12 }}>
												<Tooltip contentStyle={vuroxDarkToolTipStyles} cursor={false} />
												<Bar dataKey="value" fill="#F7614D" barSize={2} barGap ={2} />
											</BarChart>
										</ResponsiveContainer>
										<h4 className="vurox-fw-300 d-inline-block align-bottom mb-1">{props.company.bounce[0].dailyTotal}% <small className="vurox-text-sizes"> Bounce rate</small></h4>
									</Col>
								</Row>
							</VuroxComponentsContainer>
							...
							<Row gutter={{xs:4, sm:6, md:8}}>
								<Col sm={12} xs={24}>
									<VuroxComponentsContainer className="mb-2">
										...
										<ResponsiveContainer width='100%' height={130} >	
											<AreaChart data={props.company.bounce[0].monthlyStats}
								...
								<Col sm={12} xs={24}>
									<VuroxComponentsContainer>
										...
										<ResponsiveContainer width='100%' height={130}>
											<BarChart data={props.company.visitors[0].dailyStats}  margin={{ top: 20, right: 0, left: 0, bottom: 1 }}>
												<Tooltip contentStyle={vuroxDarkToolTipStyles} cursor={false} />
									...
									<Row>
										<Col md={10}>
											<ResponsiveContainer width='100%' height={140}>
												<PieChart>
													<Pie data={props.company.piedata} startAngle={360} endAngle={0} innerRadius={20} outerRadius={60} fill="#8884d8" paddingAngle={5} dataKey="value" stroke={0}>
														{
															props.company.piedata.map((entry, index) => <Cell key={`cell-${index}`} fill={entry.color} />)
														}
													</Pie>
												</PieChart>
											</ResponsiveContainer>
									...
									<Row className='pt-5 pr-2 pl-2'>
										<Col md={12} xs={24}>
											...
											<ResponsiveContainer className="rounded bg-purple-6 align-top d-inline-block mr-2 mt-1" width='30%' height={50}>
												<BarChart data={props.company.cost}  margin={{ top: 5, right: 5, left: 5, bottom: 5 }}>
									...
									<Row className='pt-5'>
										<Col md={12} xs={24}>
											<ResponsiveContainer className='d-inline-block align-top mr-2' width='40%' height={60}>
												<PieChart>
													<Pie data={props.company.piedata} startAngle={360} endAngle={0} innerRadius={15} outerRadius={30} fill="#8884d8" paddingAngle={0} dataKey="value" stroke={0}>
														{
														props.company.piedata.map((entry, index) => <Cell key={`cell-${index}`} fill={entry.color} />)
														}
													</Pie>
										...
										<Col md={12} xs={24}>
											<ResponsiveContainer className='d-inline-block align-top mr-2' width='40%' height={60}>
												<PieChart>
													<Pie data={props.company.piedata} startAngle={360} endAngle={0} innerRadius={0} outerRadius={30} fill="#8884d8" paddingAngle={1} dataKey="value" stroke={0}>
														{
														props.company.piedata.map((entry, index) => <Cell key={`cell-${index}`} fill={entry.color} />)
														}
													</Pie>
						...
						<Col md={8}>
							<VuroxComponentsContainer>
								...
								<ResponsiveContainer width='100%' height={98} >	
									<BarChart data={props.company.visitors[0].weeklyStats}  margin={{ top: 20, right: 0, left: 0, bottom: 1 }}>
										<Tooltip contentStyle={vuroxDarkToolTipStyles} cursor={false} />
...
export default connect(state=>state)(webAnalyticsTwo)