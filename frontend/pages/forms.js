...
import { UserOutlined, MailOutlined, LockOutlined, FacebookFilled, GoogleOutlined, GithubOutlined } from '@ant-design/icons';
const { Option } = Select;
...
export default connect(state=>state)(forms)