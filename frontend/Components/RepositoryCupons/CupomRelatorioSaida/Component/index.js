  ...
  render() {
    ...
    return (
      <div className="cupom_geral saida" id="cupom_nao_fiscal"> 
        ...
        <h3 className="titulo_cupom">R E L A T O R I O - S A I D A</h3>
        ...
        <div className="list_consumo_cupom saida" >
          ...
          <ul>
            ...
            <li className="saida_qtd">QTD</li>
            <li className="saida_total">Total</li>
          </ul>

          <ul class="listagem_consumo_cupom saida">
            {this.props.props.state.relatorios_saida.map(resp => {
              ...
              return (
                <li key={resp.idproduto}>
                  ...
                  <span className="saida_total">{this.props.props.formatMoney().format(contador)}</span>
                </li>
              )
            })}
          </ul>
          ...
          <div className="total_consumo_cupom footer_cupom_entrada">
            <h3>Total itens vendidos: <span>{totalitens}</span></h3>
            <h3>Total Vendas: <span>{this.props.props.formatMoney().format(totalvendas)}</span></h3>
          </div>
